...
export default function Shortlist({ shortlist }) {
  if (!shortlist.length) return (
    <div className="text-center py-20">
      ...
      <h3 style={{ fontFamily: 'DM Serif Display, serif', fontSize: '1.25rem', color: 'var(--navy-900)' }}>No candidates shortlisted</h3>
  ...
  return (
    <div className="animate-slide-up">
      <div className="flex items-center justify-between mb-5">
        <div>
          <h2 style={{ fontFamily: 'DM Serif Display, serif', fontSize: '1.5rem', color: 'var(--navy-900)' }}>Shortlisted candidates</h2>
